 ...
 */
#ifndef TVM_RUNTIME_NEW_VM_MEMORY_MANAGER_H_
#define TVM_RUNTIME_NEW_VM_MEMORY_MANAGER_H_
...
class StorageObj : public Object {
 public:
  ...
  static constexpr const char* _type_key = "new_vm.Storage";
...
#endif  // TVM_RUNTIME_NEW_VM_MEMORY_MANAGER_H_
