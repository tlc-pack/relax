...
class ExtractedTask : public runtime::ObjectRef {
 public:
   ...
   * \brief A list of low-level IRs that the high-level IR could potentially dispatch to
   */
  explicit ExtractedTask(String task_name, IRModule mod, Optional<Target> target, Array<IRModule> dispatched);
...
class MetaScheduleContextNode : public runtime::Object {
 public:
   ...
   */
  virtual Optional<ObjectRef> Query(runtime::String task_name, IRModule mod, Optional<Target> target, 
...
class MetaScheduleContext : public runtime::ObjectRef {
 ...
 public:
   ...
   *         4) IRModule for unified dispatch
   */
  static Optional<ObjectRef> QueryInsideWithScope(runtime::String task_name, IRModule mod, Optional<Target> target,
...
class TaskExtractionNode : public MetaScheduleContextNode {
 public:
  ...
  Optional<ObjectRef> Query(runtime::String task_name, IRModule mod, Optional<Target> target,
