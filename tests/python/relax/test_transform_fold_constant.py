...
def test_one_fold_addone():
    ...
    class Module:
        ...
        @R.function
        def before(c0: Tensor((16, 16), "float32")) -> Tensor:
            lv0 = relax.call_tir(addone, (c0,), (16, 16), dtype="float32")
            return lv0

        @R.function
        def expected(c1: Tensor((16, 16), "float32")) -> Tensor:
            lv0 = c1
            return c1
...
def test_one_fold_transpose():
    ...
    class Module:
        ...
        @R.function
        def before(c0: Tensor((2, 3), "float32")) -> Tensor:
            lv0 = relax.call_tir(func, (c0,), (3, 2), dtype="float32")
            return lv0

        @R.function
        def expected(c1: Tensor((3, 2), "float32")) -> Tensor:
            lv0 = c1
            return c1
...
def test_two_hop_addone():
    ...
    class Module:
        ...
        @R.function
        def before(c0: Tensor((2, 2), "float32")) -> Tensor:
            lv0 = relax.call_tir(addone, (c0,), (2, 2), dtype="float32")
            lv1 = relax.call_tir(addone, (lv0,), (2, 2), dtype="float32")
            return lv1

        @R.function
        def expected(c1: Tensor((2, 2), "float32"), c2: Tensor((2, 2), "float32")) -> Tensor:
            lv0 = c1
            lv1 = c2
            return c2
...
def test_fold_mixed_case():
    ...
    class Module:
        ...
        @R.function
        def before(c0: Tensor((16, 16), "float32"), x: Tensor((_, _), "float32")) -> Tensor:
...
def test_int32_fold():
    ...
    class Module:
        ...
        @R.function
        def before(c0: Tensor((16, 16), "int32")) -> Tensor:
            lv0 = relax.call_tir(addone, (c0,), (16, 16), dtype="int32")
            return lv0

        @R.function
        def expected(c1: Tensor((16, 16), "int32")) -> Tensor:
            lv0 = c1
            return c1
