...
def test_to_anf():
    @tvm.script.ir_module
    class TestNormalizationInputModule:
        @R.function
    ...
    before_mod = TestNormalizationInputModule
    after_mod = relax.transform.Normalization()(before_mod)
...
def test_to_anf_no_op():
    ...
    mod = TestANFNoOp
    mod_post = relax.transform.Normalization()(mod)
