...
def test_var():
    ...
    nodes = [
        ...
        {
            "type_key": "relay.Var",
            "attrs": {"checked_type_": "0", "span": "0", "type_annotation": "0", "vid": "2"},
        },
...
def test_global_var():
    nodes = [
        {"type_key": ""},
        {
            ...
            "attrs": {"checked_type_": "0", "name_hint": "x", "span": "0"},
        },
    ]
    data = {
        "root": 1,
    ...
    nodes = [
        {"type_key": ""},
        {"type_key": "GlobalVar", "attrs": {"checked_type_": "0", "name_hint": "x", "span": "0"}},
    ]
    data = {
        "root": 1,
        "nodes": nodes,
